...
<div id="layout" class="pure-g">
    <div class="sidebar pure-u-1 pure-u-md-1-4">
        <div class="header">
            <h1 class="brand-title">A Collaborative Editor</h1>
            <h2 class="brand-tagline">Creating a piece world for Vimers Emacers and Sublimers</h2>

            <nav class="nav">
                <ul class="nav-list">
                    <li class="nav-item">
                        <a class="pure-button" href="https://github.com/o0baozi0o/Collaborative-Editor">Unlimited Code Works</a>
                    </li>
                    <li class="nav-item">
                        <a class="pure-button" href="https://github.com/o0baozi0o/Collaborative-Editor">Github</a>
                    </li>
                </ul>
            </nav>
        </div>
